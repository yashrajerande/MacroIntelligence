...
- **Units are part of the number.** Every figure carries the full unit exactly as the data table gives it: the period for flows (`₹31,961 cr / month`, `13.7 mn sq ft / quarter`, `₹2,00,640 cr / month` GST) and the basis for rates (`4.45% YoY`, `1.5% SAAR`, `5.25% p.a.`, `42.6% of GDP`, `77.4% of capacity`). A bare `₹ cr`, a bare `%`, or a bare count is a defect — the reader must never guess whether SIP inflows are a month or a quarter. Levels read naturally: index points and prices take no suffix — "Nifty 23,447", "Euro Stoxx 50 at 6,300", "INR at 96.15", "Brent at $103/bbl" — never "6,299.82 index" or "96.15 ₹". Round index points to whole numbers. Stocks such as AUM and reserves keep their unit ("₹18.62 lakh cr", "$690 bn").
