...
const INDICATOR_SCHEMA = {
  ...
  // ═══════════════════════════════════════════════════════════════════
  gst_month:             { name: 'GST Collections (Month)',  section: 'S4', sub_section: 'consumption', unit: '₹ cr',       unit_desc: 'INR crore',              data_type: 'currency',   expected_range: [80000, 250000], p50: 160000, inverse: false, frequency: 'monthly' },
  gst_ytd:               { name: 'GST Collections (YTD)',    section: 'S4', sub_section: 'consumption', unit: '₹ cr',       unit_desc: 'INR crore',              data_type: 'currency',   expected_range: [800000, 2500000], p50: 1700000, inverse: false, frequency: 'quarterly' },
  ...
  inr_usd:               { name: 'INR/USD',                  section: 'S7', sub_section: 'markets',     unit: '₹',          unit_desc: 'INR per 1 USD',          data_type: 'price',      expected_range: [55, 100],        p50: 75,    inverse: true,  frequency: 'daily' },
  gold_inr_gram:         { name: 'Gold INR/gram',            section: 'S7', sub_section: 'markets',     unit: '₹/g',        unit_desc: 'INR per gram',           data_type: 'price',      expected_range: [2500, 12000],    p50: 5200,  inverse: false, frequency: 'daily' },
  ...
  re_unsold_inventory:   { name: 'Unsold Inventory',         section: 'S8', sub_section: 're_residential', unit: 'units',   unit_desc: 'dwelling units',         data_type: 'count',      expected_range: [350000, 800000], p50: 550000, inverse: true, frequency: 'quarterly' },
  ...
  home_loan_disbursements:{ name: 'Home Loan Disbursements', section: 'S8', sub_section: 're_residential', unit: '₹ cr',    unit_desc: 'INR crore',              data_type: 'currency',   expected_range: [80000, 700000],  p50: 230000, inverse: false, frequency: 'quarterly' },
  ...
  nasdaq:                { name: 'Nasdaq',                   section: 'S9', sub_section: 'global_markets',   unit: 'index', unit_desc: 'index points',           data_type: 'index',      expected_range: [6000, 35000],    p50: 18000, inverse: false, frequency: 'daily' },
